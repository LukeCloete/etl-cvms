...
export default function RewardRowCard() {
  ...
  return (
    <div>
      <div className="flex p-2 space-x-4 mb-4">
        <button
          onClick={() => setState(0)}
      ...
      <div className="flex flex-col gap-8 ">
        ...
        {(state === 0 || state === 1) && (
          <div>
            <p className="text-econetBlue font-bold mb-6">Daily DATA Bundles</p>
            <div className="flex space-x-4 ">
              <Card className=" flex flex-col justify-center items-center rounded-xl">
                ...
                <CardContent className="flex flex-col items-center ">
                  <p className="text-econetBlue font-bold pb-4">DAILY BUNDLE</p>
                  ...
                  <Dialog>
                    ...
                    <DialogContent className="">
                      ...
                      <div className="flex flex-col items-center gap-2 ">
                        ...
                        <p className="text-red-500 font-bold">200 E-Bucks</p>
                        <p className=" p-2 text-center">
                          Are you sure you want to redeem the 20 MB DAILY BUNDLE
                          for 200 E-Bucks ? <br />
